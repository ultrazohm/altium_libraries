...
CREATE OR REPLACE TABLE  `Diodes - Zener` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Library Ref` 				VARCHAR(100) NULL,
	`Type` 						VARCHAR(100) NOT NULL,
	`Power Loss` 				VARCHAR(100) NULL,
	`Zener Impedance` 			VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
	`Live Cycle Status`			VARCHAR(100) NOT NULL,
...
CREATE OR REPLACE TABLE  `Diodes - Schottky` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Library Ref` 				VARCHAR(100) NULL,
	`Type` 						VARCHAR(100) NOT NULL,
	`Forward Current` 			VARCHAR(100) NULL,
	`Forward Voltage` 			VARCHAR(100) NULL,
	`Reverse Current` 			VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
	`Live Cycle Status`			VARCHAR(100) NOT NULL,
...
CREATE OR REPLACE TABLE  `Diodes - TVS` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Library Ref` 				VARCHAR(100) NULL,
	`Type` 						VARCHAR(100) NOT NULL,
	`Peak Impuls Current` 		VARCHAR(100) NULL,
	`Power Dissipation` 		VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
	`Live Cycle Status`			VARCHAR(100) NOT NULL,
...
CREATE OR REPLACE TABLE  `MOSFET - P-Channel` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Library Ref` 				VARCHAR(100) NULL,
	`Type` 						VARCHAR(100) NOT NULL,
	`Number Of Channels` 		VARCHAR(100) NULL,
	`Drain Source Voltage` 		VARCHAR(100) NULL,
	`Drain DC Current` 			VARCHAR(100) NULL,
	`RDS On Resistance` 		VARCHAR(100) NULL,
	`Power Dissipation` 		VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
...
CREATE OR REPLACE TABLE  `Bipolartransistors` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Type` 						VARCHAR(100) NOT NULL,
	`Number Of Channels` 		VARCHAR(100) NULL,
	`Collector Emitter Voltage` VARCHAR(100) NULL,
	`Collector Basis Voltage` 	VARCHAR(100) NULL,
	`Polarization` 				VARCHAR(100) NULL,
	`Power Dissipation` 		VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
...
CREATE OR REPLACE TABLE  `Fuses - SMD` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Library Ref` 				VARCHAR(100) NULL,
	`Type` 						VARCHAR(100) NOT NULL,
	`Nominal current` 			VARCHAR(100) NULL,
	`Nominal voltage AC` 		VARCHAR(100) NULL,
	`Nominal voltage DC` 		VARCHAR(100) NULL,
...
CREATE OR REPLACE TABLE  `Logic - Operational Amplifiers` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`GBP` 						VARCHAR(100) NULL,
	`CMRR` 						VARCHAR(100) NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
	`Live Cycle Status`			VARCHAR(100) NOT NULL,
...
CREATE OR REPLACE TABLE  `Inductances - SMD` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
...
CREATE OR REPLACE TABLE  `Capacitors - THT` (
	PartID 						INT NOT NULL AUTO_INCREMENT,
	`Created On` 				TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	`Comment` 					VARCHAR(100) NULL,
	`ComponentLink1Description`	VARCHAR(100) NOT NULL,
	...
	`Voltage Rating`			VARCHAR(100) NOT NULL,
	`Value` 					VARCHAR(100) NULL,
	`Created from`				VARCHAR(100) NULL,
	`Verified by`				VARCHAR(100) NULL,
	`Live Cycle Status`			VARCHAR(100) NOT NULL,
...
ALTER TABLE `Connectors - Board to Board` ADD `Number of positions` VARCHAR(255) NULL;
ALTER TABLE `Connectors - Board to Board` ADD `Number of rows` VARCHAR(255) NULL;

ALTER TABLE `Connectors - Pin Header` ADD `Number of positions` VARCHAR(255) NULL;
ALTER TABLE `Connectors - Pin Header` ADD `Number of rows` VARCHAR(255) NULL;